// --- Ensure the DOM and Amplify library are fully loaded before running custom script ---
document.addEventListener('DOMContentLoaded', (event) => {
    console.log('DOM fully loaded and parsed. Initializing Amplify and event listeners.');
